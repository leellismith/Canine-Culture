"""
Django settings for canine_culture project.
...
WSGI_APPLICATION = 'canine_culture.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'canine-culture'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'no-reply@canineculture.com'
    EMAIL_SUBJECT_PREFIX = '[Canine Culture] '
else:
